...
{
    system("rm /tmp/listeSnapshot.txt");
    system("rm /tmp/UUIDParent.txt");
    system("rm /tmp/listeSousVolume.txt");
...
void explorateur::recupererListeSousVolume(){
